...
})(
  {
      ...
      function (require, module, exports) {
        ...
        function u(t) {
          var r = t.data,
            ...
            o = r.author,
            i = r.id,
            l = "https://www.reddit.com/u/".concat(o);
          return e.default.createElement(
            "div",
            { className: "reddit_widget__post", key: i },
        ...
        function f(t) {
          var r = t.domElement.getAttribute("data-subreddit"),
            a = n((0, e.useState)(), 2),
            o = a[0],
            i = a[1],
            l = n((0, e.useState)(""), 2),
          ...
          return (
            (0, e.useEffect)(
              function () {
                i(!0),
                  fetch("https://www.reddit.com/r/".concat(r, ".json"))
                    .then(function (e) {
                      return e.json();
                    })
                    .then(function (e) {
                      i(!1), m(e.data.children.slice(0, 10));
                    })
                    .catch(function (e) {
                      console.log(e), i(!1), f("error fetching from reddit");
                    });
              },
              [r]
            ),
            e.default.createElement(
              ...
              e.default.createElement(
                ...
                e.default.createElement(
                  "a",
                  {
                    href: "https://reddit.com/r/".concat(r),
                    rel: "noopener noreferrer",
                  },
                  "/r/",
                  r
    ...
    Focm: [
      function (require, module, exports) {
        ...
        var d = document.querySelectorAll(".reddit_widget");
